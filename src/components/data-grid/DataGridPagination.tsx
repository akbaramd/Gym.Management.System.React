...
const DataGridPagination = () => {
  ...
  return (
    <div
      ...
      data-pagination
    >
      <div className="flex items-center space-x-2 rtl:space-x-reverse order-2 md:order-1 pb-2 md:pb-0">
        <div className="text-sm text-muted-foreground">سطر در صفحه</div>
        <Select

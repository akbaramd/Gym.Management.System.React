...
const Users = () => {
  ...
  const handleRowSelection = (state: RowSelectionState) => {
    ...
    if (selectedRowIds.length > 0) {
      toast(`تعداد ${selectedRowIds.length} کاربر انتخاب شده است.`, {
        description: `چیکار میخوای باهاشون بکنی؟`,
        action: {
          label: 'برکشت',
          onClick: () => console.log('برکشت')
        }
      });
    }
  }; 
  ...
  const Toolbar = () => {
    ...
    return (
      <div className="card-header flex-wrap gap-2 border-b-0 px-5">
        <h3 className="card-title font-medium text-sm">نمایش 10 از 49,053 کاربر</h3>
          ...
          <div className="flex flex-wrap gap-2.5">
            <Select defaultValue="active">
              ...
              <SelectContent className="w-32">
                ...
                <SelectItem value="disabled">غیر فعال</SelectItem>
                <SelectItem value="pending">مسدود شده</SelectItem>
              </SelectContent>
            </Select>
            ...
            <Select defaultValue="latest">
              ...
              <SelectContent className="w-32">
                ...
                <SelectItem value="older">قدیمیترین</SelectItem>
              </SelectContent>
            </Select>

            <button className="btn btn-sm btn-outline btn-primary">
              <KeenIcon icon="setting-4" /> فیلتر
            </button>
          </div>
        </div>
      </div>
